...
{
    swaggerGenOptions.SwaggerDoc("v1", new OpenApiInfo { Title = "ASP.NET React API", Version = "v1" });
});
...
{
    swaggerUIOptions.DocumentTitle = "ASP.NET React API";
